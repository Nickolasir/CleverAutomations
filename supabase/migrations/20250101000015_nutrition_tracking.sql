...
-- ===========================================================================
-- PART 2: FOOD ITEMS (Product Reference Cache)
-- ===========================================================================
...
CREATE INDEX idx_food_items_name ON food_items (tenant_id, name);
...
CREATE INDEX idx_food_logs_user_date ON food_logs (tenant_id, user_id, logged_at DESC);
CREATE INDEX idx_food_logs_meal ON food_logs (user_id, meal_type, logged_at DESC);
...
CREATE INDEX idx_water_logs_user_date ON water_logs (tenant_id, user_id, logged_at DESC);
